const municipiosA = [
  ...
  "Aparecida do Piauí", "Aroazes", "Aroeiras do Itaim", "Arraial",
  "Assunção do Piauí", "Avelino Lopes",
];

const municipiosB = [
  "Baixa Grande do Ribeiro", "Barra D'Alcântara", "Barras",
  "Barreiras do Piauí", "Barro Duro", "Batalha", "Bela Vista do Piauí",
...
const municipiosC = [
  ...
  "Curimatá", "Currais", "Curralinhos", "Curral Novo do Piauí",
];

const municipiosD = [
  "Demerval Lobão", "Dirceu Arcoverde", "Dom Expedito Lopes",
  "Dom Inocêncio", "Domingos Mourão",
];
...
const municipiosI = [
  "Ilha Grande", "Inhuma", "Ipiranga do Piauí", "Isaías Coelho",
  "Itainópolis", "Itaueira",
];

const municipiosJ = [
  "Jacobina do Piauí", "Jaicós", "Jardim do Mulato", "Jatobá do Piauí",
  "Jerumenha", "João Costa", "Joaquim Pires", "Joca Marques",
  "José de Freitas", "Juazeiro do Piauí", "Júlio Borges", "Jurema",
];

const municipiosL = [
  "Lagoa Alegre", "Lagoa de São Francisco", "Lagoa do Barro do Piauí",
  "Lagoa do Piauí", "Lagoa do Sítio", "Lagoas do Piauí", "Landri Sales",
  "Luís Correia", "Luzilândia",
];
...
const municipiosN = [
  "Nascente do Piauí", "Nazaré do Piauí", "Nossa Senhora de Nazaré",
  "Nossa Senhora dos Remédios", "Nova Santa Rita",
  "Novo Oriente do Piauí", "Novo Santo Antônio",
];
...
const municipiosP = [
  ...
  "Palmeirais", "Paquetá", "Parnaguá", "Parnaíba",
  "Passagem Franca do Piauí", "Patos do Piauí", "Pau D'Arco do Piauí",
...
const municipiosT = [
  "Tamboril do Piauí", "Tanque do Piauí", "Teresina", "Tropical", "Tumã",
];
...
export const MUNICIPIOS_PIAUI: string[] = [
  ...municipiosA,
  ...municipiosB,
  ...municipiosC,
  ...municipiosD,
